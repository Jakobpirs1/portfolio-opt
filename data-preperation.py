...
stoxx50_components = ['ABI.BR', 'AD.AS', 'ADS.DE', 'ADYEN.AS', 'AI.PA', 'AIR.PA', 'ALV.DE', 'ASML.AS', 'BAS.DE', 'BAYN.DE', 'BBVA.MC', 'BMW.DE', 'BN.PA', 'BNP.PA', 'CRG.IR', 'CS.PA', 'DB1.DE', 'DG.PA', 'DPW.DE', 'DTE.DE', 'EL.PA', 'ENEL.MI', 'ENI.MI', 'FLTR.IR', 'IBE.MC', 'IFX.DE', 'INGA.AS', 'ISP.MI', 'ITX.MC', 'KER.PA', 'KNEBV.HE', 'LIN.DE', 'MBG.DE', 'MC.PA', 'MUV2.DE', 'OR.PA', 'PHIA.AS', 'PRX.AS', 'RI.PA', 'RMS.PA', 'SAF.PA', 'SAN.MC', 'SAN.PA', 'SAP.DE', 'SIE.DE', 'STLA', 'SU.PA', 'TTE.PA', 'VNA.DE', 'VOW.DE']
...
close_df.to_excel('stox_data12345.xlsx')
